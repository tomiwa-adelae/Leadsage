		...
		<footer className="bg-green-700 text-white">
			<div className="container">
				<div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between py-8">
					<div className="flex items-center justify-start gap-4 font-semibold text-sm lg:text-base">
				...
				<div className="py-8 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3">
					{footerLinks.map(({ title, links }, index) => (
						<div key={index}>
							...
							<ul className="space-y-6 text-sm lg:text-base mt-6 text-gray-200">
				...
				<div className="py-8">
					<p className="text-sm font-medium uppercase text-gray-300">
