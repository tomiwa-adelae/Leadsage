...
export const AnimatedTestimonials = ({
	...
	return (
		<div className="max-w-sm md:max-w-4xl mx-auto antialiased px-4 md:px-8 lg:px-12 py-2 pb-20">
			<div className="relative grid grid-cols-1 md:grid-cols-2  gap-20">
							...
							{testimonials.map((testimonial, index) => (
								...
								>
									<Image
										...
										height={1000}
										draggable={false}
										className="h-full w-auto sm:w-full rounded-3xl object-cover object-center mx-auto"
									/>
								</motion.div>
							))}
						</AnimatePresence>
				...
				<div className="flex justify-between flex-col py-4">
					...
					>
						...
						<motion.p className="text-base text-gray-100 mt-4 leading-relaxed">
